...
function buildPrompt(cellLines, codes, roster) {
  ...
  return [
    ...
    '    * family 11 (wireline / logging ops) has two sub-codes — disambiguate by the remark:',
    '        - 11A = wireline logging (CBL-VDL/USIT/CIT), perforation, set/pull BP/CR/PP',
    '          (bridge plug / cement retainer / packer plug), CCL or correlation log, dummy run,',
    '          tubing punch/cut, junk basket / gauge-ring wireline runs, VSP. Map bare "11" to 11A',
    '          for these.',
    '        - 11B = ONLY explicit PLT / Production Logging. Use 11B only when the remark clearly',
    '          says PLT or production logging.',
    '        - If a family-11 remark fits NEITHER, leave code null (needs_review) — do not force it.',

  ...
  return (
    <aside className="side">
      ...
      <nav className="nav">
        ...
        <a className={active === 'opex' ? 'on' : ''} href="#" onClick={nav('opex')}>
          <svg viewBox="0 0 24 24"><path d="M21 8V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2v-1" /><path d="M21 8h-5a2 2 0 000 4h5a1 1 0 001-1V9a1 1 0 00-1-1z" /></svg>
          OPEX
        </a>
